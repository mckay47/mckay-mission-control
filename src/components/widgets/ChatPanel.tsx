...
import { dummyChat, projects } from '../../data/dummy';
    ...
    <GlassCard className="flex flex-col min-h-[500px] h-full">
      ...
      <div className="flex items-end gap-2 pt-3 border-t border-white/5">
        ...
        <button
          onClick={handleSend}
          disabled={!input.trim()}
          className="p-3 rounded-lg bg-neon-cyan/10 border border-neon-cyan/20 text-neon-cyan hover:bg-neon-cyan/20 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
        >
