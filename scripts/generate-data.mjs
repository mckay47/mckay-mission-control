...
export const PROJ: any[] = ${toTS(projects)}

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const AGENTS: any[] = ${toTS(agents)}

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const SKILLS: any[] = ${toTS(skills)}

export const IDEAS: unknown[] = ${toTS(ideas)}

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const TODOS: any[] = ${toTS(todos)}
